defmodule Test.Process do
  def runTest do
    id = IO.gets("Enter system ID:") |> String.split("\n") |> List.first() |> String.to_integer()
  ...
  defp process([opCode: 5, modes: modes], headpos, state, _imput) do
    ...
    process(new_instruction, new_headpos, state, nil)
  end

  defp process([opCode: 6, modes: modes], headpos, state, _imput) do
    {param1, param2, _} = get_params(headpos, modes, state)
  ...
  defp process([opCode: 7, modes: modes], headpos, state, _imput) do
  ...
  defp process([opCode: 8, modes: modes], headpos, state, _imput) do
    {param1, param2, param3} = get_params(headpos, modes, state)
...
# 
# Your puzzle answer was 13346482.
# 
...
# Probleme: entre en récursion infinie pour une valeur autre que zéro
